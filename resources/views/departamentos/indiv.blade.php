                    ...
                    @if(Auth::user()->typeuser=='Administrador')
                        @if(Auth::user()->typeuser=='Administrador')
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Campo secretario(a) vacío!</h5>
                                            ...
                                            <div class="modal-body">
                                                No existe un(a) secretario(a) asociado(a) al departamento<br>
                                                Por favor actualice a un(a) nuevo(a) secretario(a)<br>
                                            </div>
                            ...
                            <div class="btn-group btn-group-sm">
                                <a class="btn btn-primary" href="{{ route('departamentos.edit', $departamento) }}">Editar</a>
                                <form method="POST" action="{{ route('departamentos.usermod', $aux) }}">
                                    @csrf @method('PATCH')
